...
- (void)addButtonClicked:(UIButton *)sender {
    [DDUShoppingCartTool addToShopingCartWithGoodsImage:[UIImage imageNamed:@"chat_btn_emoji"] startPoint:sender.center endPoint:self.shoppingCartButton.center completion:^(BOOL finished) {
        ...
        scaleAnimation.repeatCount = 2;//颤抖次数
